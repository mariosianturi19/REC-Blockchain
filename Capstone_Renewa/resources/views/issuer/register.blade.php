...
<head>
    ...
    <style>
        /* Mengadopsi semua gaya canggih dari preferensi sebelumnya */
        ...
        .modern-input { background: rgba(255, 255, 255, 0.8); backdrop-filter: blur(8px); border: 1px solid rgba(229, 231, 235, 0.6); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); }
        .modern-input:focus { background: rgba(255, 255, 255, 0.95); border-color: rgb(34, 197, 94); box-shadow: 0 0 0 3px rgba(34, 197, 94, 0.1); transform: translateY(-1px); }
...
<body class="min-h-screen flex items-center justify-center auth-gradient p-4">
    ...
    <div class="w-full max-w-4xl relative z-10">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Pendaftaran Akun Issuer</h1>
            <p class="text-gray-600">Lengkapi data institusi Anda untuk memulai proses verifikasi.</p>
        </div>
                ...
                <form method="POST" action="{{ route('issuer.register') }}" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label for="company_name" class="block text-sm font-semibold text-gray-700">Nama Institusi/Perusahaan *</label>
                                <input id="company_name" type="text" name="company_name" value="{{ old('company_name') }}" required autofocus class="modern-input w-full px-4 py-3 rounded-xl focus:outline-none placeholder-gray-400" placeholder="Masukkan nama institusi">
                            </div>
                            <div class="space-y-2">
                                <label for="nib" class="block text-sm font-semibold text-gray-700">Nomor Induk Berusaha (NIB) *</label>
                                <input id="nib" type="text" name="nib" value="{{ old('nib') }}" required class="modern-input w-full px-4 py-3 rounded-xl focus:outline-none placeholder-gray-400" placeholder="Masukkan NIB">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input id="name" type="text" name="name" value="{{ old('name') }}" required class="modern-input w-full px-4 py-3 rounded-xl focus:outline-none placeholder-gray-400" placeholder="Masukkan nama lengkap">
                            </div>
                            <div class="space-y-2">
                                <label for="email" class="block text-sm font-semibold text-gray-700">Email PIC *</label>
                                <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" class="modern-input w-full px-4 py-3 rounded-xl focus:outline-none placeholder-gray-400" placeholder="nama@email.com">
                            </div>
                            <div class="md:col-span-2 space-y-2">
                                <label for="phone" class="block text-sm font-semibold text-gray-700">Nomor Telepon PIC *</label>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2 space-y-2">
                                <label for="legal_document" class="block text-sm font-semibold text-gray-700">Unggah Dokumen Legalitas (PDF) *</label>
                                <input id="legal_document" type="file" name="legal_document" required accept=".pdf" class="modern-input w-full px-4 py-3 rounded-xl focus:outline-none file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-green-100 file:text-green-700 hover:file:bg-green-200">
                    ...
                    <div class="p-6 bg-gray-50 rounded-xl">
                        <label class="flex items-start space-x-3">
                            ...
                            <span class="text-sm text-gray-700 leading-relaxed">
                                Saya menyetujui data yang diisi adalah benar dan dapat dipertanggungjawabkan.
                            </span>
                        </label>
                    </div>
